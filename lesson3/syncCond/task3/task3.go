...
func main() {
	...
	//   4. За 10 сек main не ждёт wg: программа завершится, пока часть горутин ещё
	//      спит или ждёт в очереди. Успеет отработать примерно 15 "слотов" (3 подключения * примерно 5 волн).
}
